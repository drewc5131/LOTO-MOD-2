...
public class LOTOMod {
	...
	public static final SimpleChannel NetworkInstance = NetworkRegistry.newSimpleChannel(
			new ResourceLocation("lotomod", "main"), () -> NetworkProtocolVersion, NetworkProtocolVersion::equals,
	...
	public LOTOMod() {
		...
		NetworkInstance.<CustomNamePacket>registerMessage(0, CustomNamePacket.class, CustomNamePacket::encode,
				CustomNamePacket::new, CustomNamePacket::handle);
	}

	private void setup(final FMLCommonSetupEvent event) {
		DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> RenderingRegistry
