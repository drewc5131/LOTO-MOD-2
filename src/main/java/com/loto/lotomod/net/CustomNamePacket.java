...
public class CustomNamePacket {
	...
	private static final DataParameter<Optional<ITextComponent>> CUSTOM_PLAYER_NAME = EntityDataManager.createKey(Entity.class, DataSerializers.OPTIONAL_TEXT_COMPONENT);
